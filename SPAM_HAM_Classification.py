...
class EMOJI_HANDLING_TFIFDVectorizer(TfidfVectorizer):
    def load_emojis(self):
        filepath = 'E:/Python code/RAHUL COMPUTERS/sms spam/emoji_set.txt'
        fh = open(filepath, 'rb')
        emojis = {}
        for x in fh:
            x = x.decode()
...
def main():
    try:
        sh_classifier = SPAM_HAM_CLASSIFIER('E:/Python code/RAHUL COMPUTERS/sms spam/SMSSpamCollection')
